...
#import "CreateAccountCompany.h"
#import "MarcoConstants.h"
#import "UIImage+ResizeAdditions.h"
#import "UIImage+RoundedCornerAdditions.h"

@interface CreateAccountCompany ()

@end

@implementation CreateAccountCompany
...
- (IBAction)submitButton:(id)sender {
    ...
    if (_name.text.length == 0) {
        ...
        [currentUser setObject:[NSNumber numberWithInt:0] forKey:kMarcoTypeKey];
